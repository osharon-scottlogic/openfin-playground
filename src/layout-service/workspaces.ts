 ...
 */
 ...
 import {ChannelClient} from './types/api/interappbus/channel/client';
 import {MonitorInfo} from './types/api/system/monitor';
 import Bounds from './types/api/window/bounds';
 
import {eventEmitter, getServicePromise, tryServiceDispatch} from './connection.js';
import {WorkspaceAPI} from './internal.js';
import {WindowIdentity} from './main.js';
import {ApplicationUIConfig} from './tabbing.js';
